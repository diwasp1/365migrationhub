...
const values = [
  {
    ...
    title: "Empathy",
    description:
      "We understand that migration is a deeply personal journey filled with hopes, dreams, and challenges.",
  ...
  },
  {
    ...
    title: "Transparency",
    description:
      "Clear communication and honest advice are the foundations of our client relationships.",
  ...
  },
  {
    ...
    title: "Expertise",
    description:
      "Our MARA-registered agents bring years of experience and continuous professional development.",
  ...
  },
  {
    ...
    title: "Commitment",
    description:
      "We are dedicated to achieving the best possible outcomes for every client we serve.",
...
const milestones = [
  {
    year: "2014",
    event:
      "Founded 365 Migration Hub with a vision to provide honest migration advice",
  },
  {
    year: "2016",
    event: "Achieved MARA registration and expanded our service offerings",
  },
  {
    year: "2018",
    event: "Reached 100+ successful visa outcomes across various categories",
  },
  {
    year: "2020",
    event: "Adapted to digital consultations during global challenges",
  },
  { year: "2022", event: "Celebrated 300+ successful visa applications" },
  {
    year: "2024",
    event: "Milestone of 500+ successful visa outcomes and growing",
  },
];
      ...
      {/* <section className="relative py-20 bg-gradient-to-br from-blue-900 to-teal-700 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <motion.p
            ...
            Led by a registered migration agent with a background in law and
            ...
            <motion.div
              ...
              <div className="glass p-8 rounded-2xl backdrop-blur-sm bg-white/60 dark:bg-white/5 border border-white/20">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  ...
                  highest standards of professional service while providing the
                  personal touch that makes your migration journey as smooth as
                  possible.
                </p>
              </div>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div
            ...
            <p className="text-xl text-blue-100 max-w-4xl mx-auto leading-relaxed">
              To be a migration agency recognised for its honesty, success rate,
              and client-first approach across Australia. We envision a future
              where every migration journey is supported by expert guidance,
              cultural understanding, and unwavering commitment to success.
            </p>
          </motion.div>
        </div>
      </section>
